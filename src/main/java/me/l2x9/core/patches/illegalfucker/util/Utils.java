package me.l2x9.core.patches.illegalfucker.util;
...
public class Utils {
    ...
    public static void log(String message, Object... args) {
        ...
        L2X9RebootCore.getInstance().getLogger().log(Level.INFO, String.format("%s%c%s", message, Character.MIN_VALUE, className));
    }
